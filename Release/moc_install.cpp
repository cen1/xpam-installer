...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Install_t, stringdata) + ofs \
...
void Install::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Install::sendInfo)) {
                *result = 0;
            }
        }
        {
            typedef void (Install::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Install::setValue)) {
                *result = 1;
            }
        }
        {
...
const QMetaObject Install::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Install.data,
      qt_meta_data_Install,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Install.stringdata))
...
// SIGNAL 0
void Install::sendInfo(QString _t1)
{
...
// SIGNAL 2
void Install::finished(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

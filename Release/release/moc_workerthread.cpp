...
#include "../../installer/workerthread.h"
...
QT_MOC_LITERAL(7, 50, 1)
    ...
    "WorkerThread\0sendInfo\0\0info\0setValue\0"
    "val\0finished\0a\0"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::sendInfo)) {
                *result = 0;
            }
        }
        {
            typedef void (WorkerThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::setValue)) {
                *result = 1;
            }
        }
        {
            typedef void (WorkerThread::*_t)(bool );
...
// SIGNAL 0
void WorkerThread::sendInfo(QString _t1)
{
...
// SIGNAL 1
void WorkerThread::setValue(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void WorkerThread::finished(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
